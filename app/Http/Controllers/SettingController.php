...
class SettingController extends Controller
{
    public function index()
    {
        ...
        else
        {
            ...
            if($store_settings)
            {
                ...
                return view('settings.index', compact('getStoreThemeSetting', 'settings', 'store_settings', 'plan', 'serverIp', 'subdomain_name', 'store_payment_setting', 'store','notifications'));
            }
            else
            {
    ...
    public function saveBusinessSettings(Request $request)
    {
        ...
        {   
            ...
            if(!empty($request->title_text) || !empty($request->SITE_RTL) || !empty($request->footer_text) || !empty($request->default_language) || !empty($request->display_landing_page) || !empty($request->signup) || !empty($request->color) || !empty($request->cust_theme_bg) || !empty($request->cust_darklayout))
            {
                $post = $request->all();
        ...
        {           
            ...
            if($request->logo_light)
            {
                ...
                $logoName = $user->current_store . '_logo-light.png';
