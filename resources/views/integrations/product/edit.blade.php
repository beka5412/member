...
@section('action-btn')
    <div class="nk-block-tools g-3">
        <ul class="nav me-2">
            <li>
                <a href="#integrations_new" class="btn btn-icon btn-primary" data-bs-toggle="tab" data-bs-placement="top" title="{{__('Create Integration')}}"><em class="icon ni ni-plus"></em></a>
            </li>
        </ul>
    </div>
@endsection
                    ...
                    <div class="col-sm-8">
                        <div class="card">
                            <div class="tab-content">
                                        ...
                                        @if(!empty($products) && count($products) > 0)
                                            <tbody>
                                                ...
                                                <tr class="nk-tb-item">
                                                    ...
                                                    <td class="nk-tb-col">
                                                        <a href="{{route('integrations.product.edit', $product->id)}}">{{ $product->name }}</a>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-xs">
                                                                <ul class="link-list-plain">
                                                                    <li><a href="{{route('integrations.product.edit', $product->id)}}">Edit</a></li>
                                                                    {!! Form::open() !!}
                                ...
                                <div class="tab-pane" id="integrations_create">
                                    <div class="row g-gs">
                                        <!-- <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label" for="default-01">{{ __('Webhook URL') }}</label>
                                                <div class="form-control-wrap">
                                                    <input type="text" disabled class="form-control" id="default-01" placeholder="" value="https://rocketmember.app/webhooks/hotmart/">
                                                </div>
                                            </div>
                                        </div> -->
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" value="{{ $integration->name }}" id="default-01" placeholder="Scketh#0164098">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- <div class="col-sm-12">
                                ...
                                <div class="tab-pane active" id="integrations_new">
                                    {{ Form::model($integrationProducts, array('route' => array('integrations.product.update', $id),'method' =>'PUT')) }}
                                    <div class="row g-gs">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label" for="default-01">{{ __('Product name') }}</label>
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="name" value="{{ $integrationProducts->name }}" id="default-01" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" name="productId" value="{{ $integrationProducts->platform_product_id }}" class="form-control" id="default-01" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <select class="form-select js-select2" name="courses[]" multiple="multiple" data-placeholder="Select Multiple options">
                                                        <option value="all" @if($integrationProducts->courses == "all") selected @endif>Todos</option>
                                                        @php
                                                            $active_courses = is_array($integrationProducts->courses) ? $integrationProducts->courses : [];
                                                        @endphp
                                                        @if(!empty($courses) && count($courses) > 0)
                                                            @foreach($courses as $course)
                                                                @if (!empty($integrationProducts->courses) && in_array($course->id, $active_courses))
