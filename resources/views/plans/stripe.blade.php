                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-10 col-mg-10 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="stripe_coupon" name="coupon" class="form-control" placeholder="{{__('Enter Coupon Code Here')}}"/>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-10 col-mg-10 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="paypal_coupon" name="coupon" class="form-control" placeholder="{{__('Enter Coupon Code Here')}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 col-mg-2 col-sm-12 col-xs-12">
                                                        <a href="#" class="btn btn-print-invoice  btn-primary  m-r-10 apply-coupon">{{__('Apply')}}</a>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-10 col-mg-10 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="paystack_coupon" name="coupon" class="form-control" placeholder="{{__('Enter Coupon Code Here')}}"/>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-mg-2 col-sm-12 col-xs-12">
                                                    <a href="#" class="btn btn-print-invoice  btn-primary  m-r-10 apply-coupon">{{__('Apply')}}</a>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-10 col-mg-10 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="flutterwave_coupon" name="coupon" class="form-control" placeholder="{{__('Enter Coupon Code Here')}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 col-mg-2 col-sm-12 col-xs-12">
                                                        <a href="#" class="btn btn-print-invoice  btn-primary  m-r-10 apply-coupon">{{__('Apply')}}</a>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-10 col-mg-10 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="razorpay_coupon" name="coupon" class="form-control" placeholder="{{__('Enter Coupon Code Here')}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 col-mg-2 col-sm-12 col-xs-12">
                                                        <a href="#" class="btn btn-print-invoice  btn-primary  m-r-10 apply-coupon">{{__('Apply')}}</a>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-10 col-mg-10 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="mercado_coupon" name="coupon" class="form-control" placeholder="{{__('Enter Coupon Code Here')}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 col-mg-2 col-sm-12 col-xs-12">
                                                        <a href="#" class="btn btn-print-invoice  btn-primary  m-r-10 apply-coupon">{{__('Apply')}}</a>
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-10 col-mg-10 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="paytm_coupon" name="coupon" class="form-control" placeholder="{{__('Enter Coupon Code Here')}}"/>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-2 col-mg-2 col-sm-12 col-xs-12">
                                                            <a href="#" class="btn btn-print-invoice  btn-primary  m-r-10 apply-coupon">{{__('Apply')}}</a>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-10 col-mg-10 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="mollie_coupon" name="coupon" class="form-control" placeholder="{{__('Enter Coupon Code Here')}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 col-mg-2 col-sm-12 col-xs-12">
                                                        <a href="#" class="btn btn-print-invoice  btn-primary  m-r-10 apply-coupon">{{__('Apply')}}</a>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-10 col-mg-10 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="skrill_coupon" name="coupon" class="form-control" placeholder="{{__('Enter Coupon Code Here')}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 col-mg-2 col-sm-12 col-xs-12">
                                                        <a href="#" class="btn btn-print-invoice  btn-primary  m-r-10 apply-coupon">{{__('Apply')}}</a>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-10 col-mg-10 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="coingate_coupon" name="coupon" class="form-control" placeholder="{{__('Enter Coupon Code Here')}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 col-mg-2 col-sm-12 col-xs-12">
                                                        <a href="#" class="btn btn-print-invoice  btn-primary  m-r-10 apply-coupon">{{__('Apply')}}</a>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-lg-10 col-mg-10 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="paymentwall_coupon" name="coupon" class="form-control" placeholder="{{__('Enter Coupon Code Here')}}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2 col-mg-2 col-sm-12 col-xs-12">
                                                        <a href="#" class="btn btn-print-invoice  btn-primary  m-r-10 apply-coupon">{{__('Apply')}}</a>
