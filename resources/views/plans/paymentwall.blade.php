...
<title>@if(Auth::user()->type == 'super admin')  {{config('app.name', 'LMSGo SaaS')}} @else {{(Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'vCard SaaS')}} @endif</title>
