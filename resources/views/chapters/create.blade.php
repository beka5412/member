...
@endsection
@section('action-btn')
    <a href="{{route('course.edit',$course_id)}}" class="btn-primary p-1 rounded-circle">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.flag == "success") {
                            window.location.replace("{{route('course.edit',$course_id)}}");
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <ul class="custom-control-group">
                                <li>
                                    <div class="custom-control custom-checkbox custom-control-pro no-control checked">
                                        <input type="radio" class="custom-control-input type" value="youtube" name="type" checked id="type1">
                                ...
                                <li>
                                    ...
                                    <input type="radio" class="custom-control-input type" value="vimeo" name="type" id="type2">
                                ...
                                <li>
                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                    <input type="radio" class="custom-control-input type" value="text_content" name="type" id="type3">
                                ...
                                <li>
                                    <div class="custom-control custom-checkbox custom-control-pro no-control">
                                    <input type="radio" class="custom-control-input type" name="type" id="type4">
                            ...
                            <div class="form-group col-md-12 col-lg-12">
                                ...
                                <textarea name="chapter_description" id="summernote" style="opacity: 0;" class="summernote-basic"></textarea>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" data-id="switch-visibility" id="time" name="enable_time" value="on">
                                ...
                                <div class="d-none mt-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            {{Form::label('time_number',__('Digit a number'),['class'=>'form-label'])}}
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" data-id="switch-visibility" id="attachment">
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-right text-end float-end">
                                    ...
                                    <input type="button" id="chapter_create_submit" class="btn btn-primary btn-submit" value="{{ __('Save') }}" />
                                </div>
                            </div>
